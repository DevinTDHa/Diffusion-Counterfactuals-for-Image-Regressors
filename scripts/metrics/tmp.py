...
if __name__ == "__main__":
    res_path = "/home/tha/master-thesis-xai/thesis_utils/scripts/cf/celebahq/celebahqcf_dae_res=2025-01-02/imgs=CelebAMask-HQ_dist=l2_lr=0.0039_bt=15_opt=adam"
