...
OUTPUT_PATH=${8:-"/home/tha/thesis_runs/dae/multitarget"}
...
IMAGE_FOLDER="/home/tha/datasets/imdb-wiki-age-samples/cropped"
NAME="imdb-wiki-samples-lr=$LR-bt=$BACKWARD_T-dist=$DIST-dist_type=$DIST_TYPE-opt=$OPTIMIZER-linear_only=$LINEAR_ONLY"
...
apptainer run \
    ...
    python run_diffeocf_imdbwikiclean_multitarget.py \
