...
OUTPUT_PATH=${8:-"/home/tha/thesis_runs/dcf/celebahq"}
...
NAME="CelebaHQ_FR-lr=$LR-bt=$BACKWARD_T-dist=$DIST-dist_type=$DIST_TYPE-opt=$OPTIMIZER-linear_only=$LINEAR_ONLY"
