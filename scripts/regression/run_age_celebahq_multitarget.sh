#!/bin/bash
#SBATCH --job-name=ace_celebahq_multitarget
...
NAME="CelebaHQ_multi-method=${ATTACK_METHOD}-step=${ATACK_STEP}-dist_l1=${DIST_L1}-dist_l2=${DIST_L2}-rmodel_linear=${LINEAR_ONLY}"
